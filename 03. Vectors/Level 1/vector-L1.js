...
/*
  A vector is a dynamic array that adjusts size when a certain threshold is met when adding or removing
   ...
   capacity.  Then allow random access anywhere within that range at any time.  Even if it has not yet
   been explicitly filled.
...
Vector.prototype.resize = function() {
  ...
  //expanding capacity
  if(this.storage.length = this.capacity + 1){
